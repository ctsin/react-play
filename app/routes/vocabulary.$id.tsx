...
export async function action({ request, params }: ActionFunctionArgs) {
  ...
  try {
    // Add new relations individually to handle duplicates
    for (const relatedId of selectedIds) {
      try {
        ...
        // Ignore duplicate errors, continue with next relation
        console.log(`Relation already exists: ${vocabularyId} -> ${relatedId}`);
      }
    }
